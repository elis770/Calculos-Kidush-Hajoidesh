...
function checkIsoDateInBounds(e) {
    return checkIsoDateTimeInBounds(Object.assign(Object.assign(Object.assign({}, e), Nt), { isoHour: 12 })), e;
}
function checkIsoDateTimeInBounds(e) {
    const n = clampProp(e, "isoYear", wr, Fr, 1), t = n === wr ? 1 : n === Fr ? -1 : 0;
    return t && checkEpochNanoInBounds(isoToEpochNano(Object.assign(Object.assign({}, e), { isoDay: e.isoDay + t, isoNanosecond: e.isoNanosecond - t }))), e;
}
...
function isoToEpochNanoWithOffset(e, n) {
    ...
    return checkEpochNanoInBounds(isoToEpochNano(Object.assign(Object.assign(Object.assign({}, e), { isoDay: e.isoDay + o }), t)));
}
...
function jt(e, n = e.calendar) {
    return Object.assign({ branding: x, calendar: n }, nn(Nr, e));
}
function W(e, n = e.calendar) {
    return Object.assign({ branding: G, calendar: n }, nn(Ir, e));
}
function createPlainYearMonthSlots(e, n = e.calendar) {
    return Object.assign({ branding: Ut, calendar: n }, nn(Ir, e));
}
function createPlainMonthDaySlots(e, n = e.calendar) {
    return Object.assign({ branding: qt, calendar: n }, nn(Ir, e));
}
function St(e) {
    return Object.assign({ branding: ft }, nn(Mr, e));
}
function Oe(e) {
    return Object.assign({ branding: N, sign: computeDurationSign(e) }, nn(ur, e));
}
function I(e) {
...
function clampRelativeDuration(e, n, t, o, r, i, a) {
    const s = p[t], c = Object.assign(Object.assign({}, n), { [s]: n[s] + o }), u = a(e, r, n), f = a(e, r, c);
    return [i(u), i(f)];
}
...
function roundDateTimeToNano(e, n, t) {
    ...
    return checkIsoDateTimeInBounds(Object.assign(Object.assign({}, moveByDays(e, r)), o));
}
...
function nudgeDayTimeDuration(e, n, t, o, r, i) {
    ...
    return [Object.assign(Object.assign({}, e), l), addBigNanos(n, u), f];
}
function nudgeZonedTimeDuration(e, n, t, o, r, i, a, s, c, u) {
    ...
    const [p, h] = clampRelativeDuration(a, Object.assign(Object.assign({}, e), hr), 6, f, s, c, u), g = m - bigNanoToNumber(diffBigNanos(p, h));
    let D = 0;
    g && Math.sign(g) !== f ? n = moveBigNano(p, m) : (D += f, m = roundByInc(g, d, i),
        n = moveBigNano(h, m));
    const T = nanoToDurationTimeFields(m);
    return [Object.assign(Object.assign(Object.assign({}, e), T), { days: e.days + D }), n, Boolean(D)];
}
function nudgeRelativeDuration(e, n, t, o, r, i, a, s, c, u) {
    const f = computeDurationSign(e), l = p[o], d = gr(o, e);
    7 === o && (e = Object.assign(Object.assign({}, e), { weeks: e.weeks + Math.trunc(e.days / 7) }));
...
function k(e, n) {
    ...
    return o > 1 && checkDurationUnits(e = Object.assign(Object.assign({}, e), roundDayTimeDurationByInc(e, o, t))), ((e, n) => {
...
function _zonedEpochSlotsToIso(e, n) {
    ...
    return Object.assign(Object.assign({ calendar: e.calendar }, r), { offsetNanoseconds: o });
}
...
function pe(e, n, t, o, r, i = Object.create(null)) {
    ...
    return Object.assign(Object.assign({}, o), moveZonedEpochs(a, s, o, t ? negateDurationFields(r) : r, i));
}
...
function Gt(e, n, t, o, r) {
    ...
    n && (o = B(o)), o.sign < 0 && (s = a.P(s, Object.assign(Object.assign({}, pr), { months: 1 })), s = moveByDays(s, -1));
    const c = a.P(s, o, r);
...
function moveZonedEpochs(e, n, t, o, r) {
    ...
    if (durationHasDateParts(o)) {
        const s = he(t, e);
        a = addBigNanos(getSingleInstantFor(e, Object.assign(Object.assign({}, moveDate(n, s, Object.assign(Object.assign({}, o), hr), r)), nn(w, s))), i);
    }
    else {
...
function moveDateTime(e, n, t, o) {
    ...
    return checkIsoDateTimeInBounds(Object.assign(Object.assign({}, moveDate(e, n, Object.assign(Object.assign(Object.assign({}, t), hr), { days: t.days + i }), o)), r));
}
...
function moveByDays(e, n) {
    return n ? Object.assign(Object.assign({}, e), epochMilliToIso(isoToEpochMilli(e) + n * ko)) : e;
}
function createMarkerSystem(e, n, t) {
    const o = e(t.calendar);
    return isZonedEpochSlots(t) ? [t, o, n(t.timeZone)] : [Object.assign(Object.assign({}, t), Nt), o];
}
...
function E(e, n, t, o, r, i, a) {
    ...
    if (isUniformUnit(c, s)) {
        return Oe(checkDurationUnits(((e, n, t, o) => {
            ...
            return Object.assign(Object.assign({}, pr), nanoToDurationDayTimeFields(r, t));
        })(r, i, c, o)));
    }
    if (!s) {
        throw new RangeError(yo);
...
function V(e, n, t, o, r) {
    ...
    if (!f && l <= 6) {
        return Oe(checkDurationUnits(((e, n, t, o, r) => {
            ...
            return Object.assign(Object.assign({}, pr), nanoToDurationDayTimeFields(i, n));
        })(o, a, s, c, u)));
    }
...
function de(e, n, t) {
    ...
    return n ? o.calendar === l && (o = -271821 === o.isoYear && 4 === o.isoMonth ? Object.assign(Object.assign(Object.assign({}, o), { isoDay: 20 }), Nt) : Object.assign(Object.assign(Object.assign({}, o), { isoDay: 1 }), Nt)) : t && o.calendar === l && (o = Object.assign(Object.assign({}, o), { isoYear: Br })), W(o.C ? finalizeDateTime(o) : finalizeDate(o));
}
function _t(e, n) {
...
function R(e) {
    const n = (e => {
        ...
        return n ? (e => {
            ...
            let n = 0, t = 0, o = 0, r = Object.assign(Object.assign({}, zipProps(p, [parseUnit(e[2]), parseUnit(e[3]), parseUnit(e[4]), parseUnit(e[5]), parseUnit(e[6], e[7], 5), parseUnit(e[8], e[9], 4), parseUnit(e[10], e[11], 3)])), nanoToGivenFields(o, 2, p));
            if (!n) {
...
function resolveSlotsCalendar(e) {
    return Object.assign(Object.assign({}, e), { calendar: u(e.calendar) });
}
function parseDateTimeLike(e) {
    const n = vi.exec(e);
    return n ? (e => {
        const n = e[10], t = "Z" === (n || "").toUpperCase();
        return Object.assign(Object.assign(Object.assign({ isoYear: organizeIsoYearParts(e), isoMonth: parseInt(e[4]), isoDay: parseInt(e[5]) }, organizeTimeParts(e.slice(5))), organizeAnnotationParts(e[16])), { C: Boolean(e[6]), j: t, offset: t ? void 0 : n });
    })(n) : void 0;
}
function parseYearMonthOnly(e) {
    const n = Ni.exec(e);
    return n ? (e => (Object.assign({ isoYear: organizeIsoYearParts(e), isoMonth: parseInt(e[4]), isoDay: 1 }, organizeAnnotationParts(e[5]))))(n) : void 0;
}
function parseMonthDayOnly(e) {
    const n = yi.exec(e);
    return n ? (e => (Object.assign({ isoYear: Br, isoMonth: parseInt(e[1]), isoDay: parseInt(e[2]) }, organizeAnnotationParts(e[3]))))(n) : void 0;
}
...
function organizeTimeParts(e) {
    ...
    return Object.assign(Object.assign({}, nanoToIsoTimeAndDay(parseSubsecNano(e[4] || ""))[0]), { isoHour: parseInt0(e[1]), isoMinute: parseInt0(e[2]), isoSecond: 60 === n ? 59 : n });
}
...
function it(e, n, t, o) {
    const [r, i, a, s] = refineDiffOptions(e, o, 5, 5), c = roundByInc(diffTimes(n, t), computeNanoInc(i, a), s), u = Object.assign(Object.assign({}, pr), nanoToDurationTimeFields(c, r));
...
function diffZonedEpochsBig(e, n, t, o, r, i, a) {
    const [s, c, u] = ((e, n, t, o) => {
        function updateMid() {
            return f = Object.assign(Object.assign({}, moveByDays(a, c++ * -o)), i), l = getSingleInstantFor(e, f), compareBigNanos(s, l) === -o;
        }
    ...
    var f, l;
    return Object.assign(Object.assign({}, 6 === i ? (f = s, l = c, Object.assign(Object.assign({}, pr), { days: diffDays(f, l) })) : e.N(s, c, i, a)), nanoToDurationTimeFields(u));
}
function diffDateTimesBig(e, n, t, o, r, i) {
    ...
    return Object.assign(Object.assign({}, e.N(a, s, r, i)), nanoToDurationTimeFields(c));
}
function diffEpochNanos(e, n, t, o, r, i) {
    return Object.assign(Object.assign({}, pr), nanoToDurationDayTimeFields(roundBigNano(diffBigNanos(e, n), o, r, i), t));
}
function diffEpochNanosExact(e, n, t) {
    return Object.assign(Object.assign({}, pr), nanoToDurationDayTimeFields(diffBigNanos(e, n), t));
}
...
function createIntlCalendar(e) {
    function epochMilliToIntlFields(e) {
        return ((e, n) => (Object.assign(Object.assign({}, parseIntlYear(e, n)), { o: e.month, day: parseInt(e.day) })))(hashIntlFormatParts(n, e), t);
    }
...
function $(e, n, t, o) {
    ...
    if (void 0 !== r.timeZone) {
        ...
        return {
            epochNanoseconds: getMatchingInstantFor(n(a), Object.assign(Object.assign({}, o), i), void 0 !== r.offset ? parseOffsetNano(r.offset) : void 0),
            timeZone: a
        };
    }
    return Object.assign(Object.assign({}, t.F(r)), Nt);
}
function Ne(e, n, t, o, r, i) {
    ...
    return _e(getMatchingInstantFor(n(s), Object.assign(Object.assign({}, l), d), void 0 !== a.offset ? parseOffsetNano(a.offset) : void 0, u, f), s, o);
}
function At(e, n, t) {
    const o = refineCalendarFields(e, n, Xo, [], O), r = mt(t);
    return jt(checkIsoDateTimeInBounds(Object.assign(Object.assign({}, e.F(o, fabricateOverflowOptions(r))), refineTimeBag(o, r))));
}
function me(e, n, t, o = []) {
...
function q(e) {
    ...
    return Oe(checkDurationUnits(Object.assign(Object.assign({}, pr), n)));
}
...
function refineTimeBag(e, n) {
    return constrainIsoTimeFields(xi(Object.assign(Object.assign({}, tr), e)), n);
}
function De(e, n, t, o, r) {
    const { calendar: i, timeZone: a } = t, s = e(i), c = n(a), u = [...s.fields(Xo), ...Lo].sort(), f = (e => {
        ...
        return Object.assign(Object.assign({}, $i(n)), { year: r, monthCode: u, day: a, offset: t });
    })(t), l = refineFields(o, u), d = s.k(f, l), m = Object.assign(Object.assign({}, f), l), [p, h, g] = je(r, 2);
    return _e(getMatchingInstantFor(c, Object.assign(Object.assign({}, s.F(d, fabricateOverflowOptions(p))), constrainIsoTimeFields(xi(m), p)), parseOffsetNano(m.offset), h, g), a, i);
}
function gt(e, n, t, o) {
    const r = e(n.calendar), i = [...r.fields(Xo), ...O].sort(), a = Object.assign(Object.assign({}, computeDateEssentials(s = n)), { hour: s.isoHour, minute: s.isoMinute, second: s.isoSecond, millisecond: s.isoMillisecond, microsecond: s.isoMicrosecond, nanosecond: s.isoNanosecond });
    var s;
    const c = refineFields(t, i), u = mt(o), f = r.k(a, c), l = Object.assign(Object.assign({}, a), c);
    return jt(checkIsoDateTimeInBounds(Object.assign(Object.assign({}, r.F(f, fabricateOverflowOptions(u))), constrainIsoTimeFields(xi(l), u))));
}
function ee(e, n, t, o) {
...
function rt(e, n, t) {
    return St(((e, n, t) => refineTimeBag(Object.assign(Object.assign({}, nn(qo, e)), refineFields(n, qo)), mt(t)))(e, n, t));
}
function A(e, n) {
    return Oe((t = e, o = n, checkDurationUnits(Object.assign(Object.assign({}, t), refineFields(o, ur)))));
    var t, o;
}
...
function ae(e, n, t, o, r) {
    ...
    let u;
    return u = s ? getSingleInstantFor(c, Object.assign(Object.assign({}, o), s)) : getStartOfDayInstantFor(c, Object.assign(Object.assign({}, o), Nt)), _e(u, i, o.calendar);
}
function ie(e, n = Nt) {
    return jt(checkIsoDateTimeInBounds(Object.assign(Object.assign({}, e), n)));
}
function le(e, n, t) {
    return ((e, n) => {
...
function createOptionsTransformer(e, n, t) {
    ...
    return (r, i) => {
        ...
        if (!hasAnyPropsByName(r = ((e, n) => {
            ...
            r = Object.assign(Object.assign({}, n), r);
        }
...
function ge(e, n, t) {
    const o = n.timeZone, r = e(o), i = Object.assign(Object.assign({}, he(n, r)), t || Nt);
    let a;
...
function pt(e, n) {
    return Object.assign(Object.assign({}, e), { calendar: n });
}
function Pe(e, n) {
    return Object.assign(Object.assign({}, e), { timeZone: n });
}
function tn(e) {
    const n = Xe();
...
class FixedTimeZone {
    ...
    I(e) {
        return (e => {
            const n = isoToEpochNano(Object.assign(Object.assign({}, e), Nt));
...
const mi = "([+-])", pi = "(?:[.,](\\d{1,9}))?", hi = `(?:(?:${mi}(\\d{6}))|(\\d{4}))-?(\\d{2})`, gi = "(\\d{2})(?::?(\\d{2})(?::?(\\d{2})" + pi + ")?)?", Di = mi + gi, Ti = hi + "-?(\\d{2})(?:[T ]" + gi + "(Z|" + Di + ")?)?", Ii = "\\[(!?)([^\\]]*)\\]", Mi = `((?:${Ii}){0,9})`, Ni = /*@__PURE__*/ createRegExp(hi + Mi), yi = /*@__PURE__*/ createRegExp("(?:--)?(\\d{2})-?(\\d{2})" + Mi), vi = /*@__PURE__*/ createRegExp(Ti + Mi), Pi = /*@__PURE__*/ createRegExp("T?" + gi + "(?:" + Di + ")?" + Mi), Ei = /*@__PURE__*/ createRegExp(Di), Si = /*@__PURE__*/ new RegExp(Ii, "g"), Fi = /*@__PURE__*/ createRegExp(`${mi}?P(\\d+Y)?(\\d+M)?(\\d+W)?(\\d+D)?(?:T(?:(\\d+)${pi}H)?(?:(\\d+)${pi}M)?(?:(\\d+)${pi}S)?)?`), wi = /*@__PURE__*/ on((e => new en(br, {
    ...
    N(e, n, t) {
        if (t <= 7) {
            let o = 0, r = diffDays(Object.assign(Object.assign({}, e), Nt), Object.assign(Object.assign({}, n), Nt));
            return 7 === t && ([o, r] = divModTrunc(r, 7)), Object.assign(Object.assign({}, pr), { weeks: o, days: r });
        }
        ...
        return 8 === t && (a += this.cn(i, o[0]), i = 0), Object.assign(Object.assign({}, pr), { years: i, months: a, days: s });
    },
    F(e, n) {
...
}), ji = /*@__PURE__*/ createNativeOpsCreator(Ri, Ai), C = /*@__PURE__*/ createNativeOpsCreator(Ui, Wi), Li = Object.assign(Object.assign(Object.assign({
...
}, /*@__PURE__*/ wo(O, toInteger)), /*@__PURE__*/ wo(p, toStrictInteger)), { offset(e) {
        const n = toStringViaPrimitive(e);
...
function createSlotClass(i, l, s, c, u) {
    ...
    return Object.defineProperties(Class.prototype, Object.assign(Object.assign(Object.assign({}, t(e(bindMethod, s))), n(e(bindMethod, c))), o("Temporal." + i))), Object.defineProperties(Class, Object.assign(Object.assign({}, n(u)), r(i))), [Class, t => {
...
function refinePublicRelativeTo(t) {
    if (void 0 !== t) {
        if (s(t)) {
            ...
            return Object.assign(Object.assign({}, $(refineTimeZoneArg, L, C(n), t)), { calendar: n });
        }
        return H(t);
    }
}
    ...
    if (s(t)) {
        ...
        switch (n.branding) {
            case x:
                return mt(e), n;
            case G:
                return mt(e), jt(Object.assign(Object.assign({}, n), Nt));
            case z:
                return mt(e), yt(L, n);
        }
...
const sn = /*@__PURE__*/ new WeakMap, cn = /*@__PURE__*/ sn.get.bind(sn), un = /*@__PURE__*/ sn.set.bind(sn), fn = {
    ...
    yearOfWeek: S,
    daysInWeek: h
}, Tn = /*@__PURE__*/ createCalendarGetters(/*@__PURE__*/ Object.assign({}, fn, mn, dn, Sn)), hn = /*@__PURE__*/ createCalendarGetters(Object.assign(Object.assign({}, fn), mn)), Dn = /*@__PURE__*/ createCalendarGetters(Object.assign(Object.assign({}, mn), dn)), Pn = {
    calendarId: t => t.calendar
}, gn = /*@__PURE__*/ g((t => e => e[t]), p.concat("sign")), pn = /*@__PURE__*/ g(((t, e) => t => t[w[e]]), O), On = {
    epochMilliseconds: I,
    epochNanoseconds: v
}, [wn, In] = createSlotClass(N, j, Object.assign(Object.assign({}, gn), { blank: y }), {
    with: (t, e) => In(A(t, e)),
    negated: t => In(B(t)),
    abs: t => In(Y(t)),
...
}), [Yn, En] = createSlotClass(x, Pt(Zt, Mt), Object.assign(Object.assign(Object.assign({}, Pn), Tn), pn), {
...
}), [Ln, Vn] = createSlotClass(qt, Pt(kt, Mt), Object.assign(Object.assign({}, Pn), Dn), {
...
}), [kn, qn] = createSlotClass(Ut, Pt(Qt, Mt), Object.assign(Object.assign({}, Pn), hn), {
...
}), [xn, Wn] = createSlotClass(G, Pt(ue, Mt), Object.assign(Object.assign({}, Pn), Tn), {
...
}), [zn, $n] = createSlotClass(z, Pt(ye, Mt, Ze), Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, On), Pn), adaptDateMethods(Tn)), adaptDateMethods(pn)), { offset: t => Se(slotsToIso(t).offsetNanoseconds), offsetNanoseconds: t => slotsToIso(t).offsetNanoseconds, timeZoneId: t => t.timeZone, hoursInDay: t => Te(L, t) }), {
    ...
    getTimeZoneTransition(t, e) {
        ...
        return a ? $n(Object.assign(Object.assign({}, t), { epochNanoseconds: a })) : null;
    }
}, {
...
}), Un = /*@__PURE__*/ Object.defineProperties({}, Object.assign(Object.assign({}, o("Temporal.Now")), n({
    timeZoneId: () => Ue(),
    instant: () => Kn(xe(Xe())),
...
}))), Xn = /*@__PURE__*/ Object.defineProperties({}, Object.assign(Object.assign({}, o("Temporal")), n({
    PlainYearMonth: kn,
    PlainMonthDay: Ln,
    PlainDate: xn,
    PlainTime: An,
    ...
    Duration: wn,
    Now: Un
}))), _n = /*@__PURE__*/ createDateTimeFormatClass(), to = /*@__PURE__*/ new WeakMap; /*@__PURE__*/
Object.defineProperties(Object.create(Intl), n({
    DateTimeFormat: _n
}));
...
class QuickLRU extends Map {
    ...
    expiresIn(key) {
        var _b;
        const item = (_b = __classPrivateFieldGet(this, _QuickLRU_cache, "f").get(key)) !== null && _b !== void 0 ? _b : __classPrivateFieldGet(this, _QuickLRU_oldCache, "f").get(key);
        if (item) {
    ...
    delete(key) {
        ...
        if (deleted) {
            __classPrivateFieldSet(this, _QuickLRU_size, (_b = __classPrivateFieldGet(this, _QuickLRU_size, "f"), _b--, _b), "f");
        }
...
function getHolidaysForYear_(year) {
    ...
    add(new HolidayEvent(new HDate(tzomGedaliahDay, TISHREI, year), holidayDesc.TZOM_GEDALIAH, MINOR_FAST$1));
    // first SAT after RH
    ...
    add(new HolidayEvent(new HDate(HDate.dayOnOrBefore(SAT$1, new HDate(1, TISHREI, year + 1).abs() - 4)), holidayDesc.LEIL_SELICHOT, MINOR_HOLIDAY$1, { emoji: '🕍' }));
